...
"""Parallel eval suite runner for Qwen3-VL with trap injection."""
...
_MODEL = flags.DEFINE_string('model', 'Qwen3-VL-8B-Instruct', 'Model name.')
...
def _main() -> None:
    ...
    print(f'Parallel runner (Qwen3-VL + Trap): {num_workers} workers')
