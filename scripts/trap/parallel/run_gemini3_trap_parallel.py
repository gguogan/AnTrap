...
"""Parallel eval suite runner for Gemini 3 with trap injection."""
...
_ENDPOINT = flags.DEFINE_string(
    'endpoint', '',
    'Gemini API host. If empty, falls back to GEMINI_ENDPOINT env var, '
...
def worker(
    ...
    try:
        ...
        llm_wrapper = infer_gemini3.Gemini3RestWrapper(
...
def _main() -> None:
    ...
    print(f'Parallel runner (Gemini 3 + Trap): {num_workers} workers')
