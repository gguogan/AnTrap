#!/bin/bash
# ============================================================================
# MAI-UI Parallel Runner with Trap Injection
# ============================================================================
#
# Usage:
#   # Baseline (no trap, results -> log/origin/)
#   bash scripts/trap/parallel/run_maiui_trap_parallel.sh
#
...
#   TRAP_CATEGORY=a_layer TRAP_TYPE=grounding_error \
#     bash scripts/trap/parallel/run_maiui_trap_parallel.sh log/trap/MAI-UI-8B/log_xxx.log
#
# ----------------------------------------------------------------------------
...
if [ -n "$RESUME_LOG" ]; then
    ...
    python scripts/trap/parallel/run_maiui_trap_parallel.py \
