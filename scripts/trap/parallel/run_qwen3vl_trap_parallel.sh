#!/bin/bash
# ============================================================================
# Qwen3-VL Parallel Runner with Trap Injection
# ============================================================================
#
# Usage:
#   # Baseline (no trap, results -> log/origin/)
#   bash scripts/trap/parallel/run_qwen3vl_trap_parallel.sh
#
...
#   TRAP_CATEGORY=a_layer TRAP_TYPE=grounding_error \
#     bash scripts/trap/parallel/run_qwen3vl_trap_parallel.sh log/trap/Qwen3-VL-8B-Thinking/log_xxx.log
#
# ----------------------------------------------------------------------------
...
if [ -n "$RESUME_LOG" ]; then
    ...
    python scripts/trap/parallel/run_qwen3vl_trap_parallel.py \
