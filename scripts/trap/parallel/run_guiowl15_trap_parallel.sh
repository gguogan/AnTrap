#!/bin/bash
# ============================================================================
# GUI-Owl-1.5 Parallel Runner with Trap Injection
# ============================================================================
#
# Usage:
#   # Baseline (no trap, results -> log/origin/)
#   bash scripts/trap/parallel/run_guiowl15_trap_parallel.sh
#
...
#   TRAP_CATEGORY=a_layer TRAP_TYPE=grounding_error \
#     bash scripts/trap/parallel/run_guiowl15_trap_parallel.sh log/trap/GUI-Owl-1.5-8B-Think/log_xxx.log
#
# ----------------------------------------------------------------------------
...
MODEL="${MODEL:-GUI-Owl-1.5-8B-Think}"
...
if [ -n "$RESUME_LOG" ]; then
    ...
    python scripts/trap/parallel/run_guiowl15_trap_parallel.py \
