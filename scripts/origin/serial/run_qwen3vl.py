...
"""Run eval suite for Qwen3-VL agent."""
...
def _main() -> None:
    ...
    print(f'Initializing {_AGENT_NAME.value} agent...')
    ...
    print(f'Starting eval with {_AGENT_NAME.value} agent, writing to {checkpoint_dir}')
    suite_utils.run(
        suite,
        agent,
