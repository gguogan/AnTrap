...
"""Run eval suite for UI-TARS agent.
...
# Agent specific.
_AGENT_NAME = flags.DEFINE_string('agent_name', 'ui_tars', help='Agent name.')
...
def _get_agent(
    ...
    if _AGENT_NAME.value == 'ui_tars':
        ...
        agent = ui_tars.UITarsAgent(
            ...
            src_format='rel',  # UI-TARS uses normalized coordinates
