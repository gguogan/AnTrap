...
"""Parallel eval suite runner for MAI-UI agent."""
...
_MODEL = flags.DEFINE_string('model', 'MAI-UI-8B', 'Model name served by vllm.')
...
_MAX_HISTORY_IMAGES = flags.DEFINE_integer('max_history_images', 3, 'Max past screenshots in prompt.')
        ...
        while True:
            ...
            try:
                ...
                episode = {
                    ...
                    constants.EpisodeConstants.AGENT_NAME: f'MAIUI_w{worker_id}',
                }
            finally:
...
def _main() -> None:
    ...
    print(f'Parallel runner (MAI-UI): {num_workers} workers')
