...
# Usage:  bash run_guiowl15_parallel.sh                           # fresh run
#         bash run_guiowl15_parallel.sh log/log_XXX.log           # resume
RESUME_LOG="$1"
...
if [ -n "$RESUME_LOG" ]; then
    ...
    python scripts/origin/parallel/run_gui_owl_1_5_parallel.py \
