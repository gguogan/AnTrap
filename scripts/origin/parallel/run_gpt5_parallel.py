...
"""Parallel eval suite runner for GPT via /v1/chat/completions (OpenAI-compat proxy)."""
...
_MODEL = flags.DEFINE_string('model', 'gpt-5.4-mini', 'GPT model id (e.g. gpt-5.4 / gpt-5.4-mini).')
        ...
        while True:
            ...
            try:
                ...
                episode = {
                    ...
                    constants.EpisodeConstants.AGENT_NAME: f'Gpt5_w{worker_id}',
                }
            finally:
...
def _main() -> None:
    ...
    print(f'Parallel runner (GPT): {num_workers} workers')
