...
class BrowserTask(task_eval.TaskEval):
  ...
  def initialize_task(self, env: interface.AsyncEnv):
    ...
    # Clear Chrome's default app association to prevent "Always" choice from previous tasks
    # # from blocking the "Open with" dialog
    # adb_utils.issue_generic_request(
    #     ['shell', 'cmd', 'package', 'clear-defaults', 'com.android.chrome'],
    #     env.controller,
    # )
